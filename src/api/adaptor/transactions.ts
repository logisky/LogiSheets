...
export function adaptTransaction(t: Transaction): EditAction {
    if (t instanceof UndoTransaction) return 'Undo'
...
function adapatSetFont(p: SetFont): EditPayload {
    ...
    if (p.bold !== undefined) payload.setFontBold = p.bold
    if (p.italic !== undefined) payload.setFontItalic = p.italic
    if (p.underline !== undefined) payload.setFontUnderline = p.underline
    if (p.color !== undefined) payload.setFontColor = p.color
    if (p.size !== undefined) payload.setFontSize = p.size
    if (p.name !== undefined) payload.setFontName = p.name
    if (p.outline !== undefined) payload.setFontOutline = p.outline
    if (p.shadow !== undefined) payload.setFontShadow = p.shadow
    if (p.strike !== undefined) payload.setFontStrike = p.strike
    if (p.condense !== undefined) payload.setFontCondense = p.condense
    return {
        StyleUpdate: {
            sheetIdx: p.sheetIdx,
            row: p.row,
...
function adaptSetBorder(p: SetBorder): EditPayload {
    const payload = initStyleUpdate()
    if (p.leftColor !== undefined) payload.setLeftBorderColor = p.leftColor
    if (p.rightColor !== undefined) payload.setRightBorderColor = p.rightColor
    if (p.topColor !== undefined) payload.setTopBorderColor = p.topColor
    ...
    if (p.diagonalUp !== undefined) payload.setBorderGiagonalUp = p.diagonalUp
...
function initStyleUpdate(): StyleUpdateType {
    return {
        setBorderGiagonalDown: undefined,
        setBorderGiagonalUp: undefined,
        setBottomBorderColor: undefined,
        setBottomBorderStyle: undefined,
        setFontBold: undefined,
        setFontColor: undefined,
        setFontCondense: undefined,
        setFontItalic: undefined,
        setFontName: undefined,
        setFontOutline: undefined,
        setFontShadow: undefined,
        setFontSize: undefined,
        setFontStrike: undefined,
        setFontUnderline: undefined,
        setLeftBorderColor: undefined,
        setLeftBorderStyle: undefined,
        setPatternFill: undefined,
        setRightBorderColor: undefined,
        setRightBorderStyle: undefined,
        setTopBorderColor: undefined,
        setTopBorderStyle: undefined,
    }
}
