...
export const protobufPackage = "network.proto";
...
export interface BlockStyleUpdate {
  ...
  row: number;
  col: number;
  payload: StyleUpdatePayload | undefined;
}
...
export interface StyleUpdatePayload {
  stylePayloadOneof?:
    ...
    | { $case: "setBorderPr"; setBorderPr: SetBorderPr }
...
function createBaseClientSend(): ClientSend {
  return { clientSendOneof: undefined, user: "", fileId: "" };
}
...
function createBaseBlockStyleUpdate(): BlockStyleUpdate {
  return { sheetIdx: 0, id: 0, row: 0, col: 0, payload: undefined };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.payload = StyleUpdatePayload.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): BlockStyleUpdate {
    return {
      ...
      payload: isSet(object.payload)
        ? StyleUpdatePayload.fromJSON(object.payload)
        : undefined,
    };
  },
  ...
  toJSON(message: BlockStyleUpdate): unknown {
    ...
    message.payload !== undefined &&
      (obj.payload = message.payload
        ? StyleUpdatePayload.toJSON(message.payload)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<BlockStyleUpdate>, I>>(
    ...
    message.payload =
      object.payload !== undefined && object.payload !== null
        ? StyleUpdatePayload.fromPartial(object.payload)
        : undefined;
    return message;
  },
};
...
function createBaseSetBorderPr(): SetBorderPr {
  return { location: 0, pr: undefined };
}

export const SetBorderPr = {
  encode(
    message: SetBorderPr,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    ...
    if (message.pr !== undefined) {
      BorderPr.encode(message.pr, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SetBorderPr {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSetBorderPr();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.pr = BorderPr.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): SetBorderPr {
    return {
      location: isSet(object.location)
        ? borderLocationFromJSON(object.location)
        : 0,
      pr: isSet(object.pr) ? BorderPr.fromJSON(object.pr) : undefined,
    };
  },

  toJSON(message: SetBorderPr): unknown {
    const obj: any = {};
    message.location !== undefined &&
      (obj.location = borderLocationToJSON(message.location));
    message.pr !== undefined &&
      (obj.pr = message.pr ? BorderPr.toJSON(message.pr) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SetBorderPr>, I>>(
    object: I
  ): SetBorderPr {
    const message = createBaseSetBorderPr();
    message.location = object.location ?? 0;
    message.pr =
      object.pr !== undefined && object.pr !== null
        ? BorderPr.fromPartial(object.pr)
        : undefined;
    return message;
  },
};
...
export const StyleUpdatePayload = {
  encode(
    ...
    if (message.stylePayloadOneof?.$case === "setBorderPr") {
      SetBorderPr.encode(
        message.stylePayloadOneof.setBorderPr,
        writer.uint32(114).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          message.stylePayloadOneof = {
            $case: "setBorderPr",
            setBorderPr: SetBorderPr.decode(reader, reader.uint32()),
          };
          break;
        case 15:
          message.stylePayloadOneof = {
  ...
  fromJSON(object: any): StyleUpdatePayload {
    return {
      stylePayloadOneof: isSet(object.setFontBold)
        ...
        : isSet(object.setBorderPr)
        ? {
            $case: "setBorderPr",
            setBorderPr: SetBorderPr.fromJSON(object.setBorderPr),
          }
  ...
  toJSON(message: StyleUpdatePayload): unknown {
    ...
    message.stylePayloadOneof?.$case === "setBorderOutline" &&
      (obj.setBorderOutline = message.stylePayloadOneof?.setBorderOutline
        ...
        : undefined);
    message.stylePayloadOneof?.$case === "setBorderPr" &&
      (obj.setBorderPr = message.stylePayloadOneof?.setBorderPr
        ? SetBorderPr.toJSON(message.stylePayloadOneof?.setBorderPr)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<StyleUpdatePayload>, I>>(
    ...
    if (
      object.stylePayloadOneof?.$case === "setBorderPr" &&
      object.stylePayloadOneof?.setBorderPr !== undefined &&
      object.stylePayloadOneof?.setBorderPr !== null
    ) {
      message.stylePayloadOneof = {
        $case: "setBorderPr",
        setBorderPr: SetBorderPr.fromPartial(
          object.stylePayloadOneof.setBorderPr
        ),
      };
    }
    if (
...
function createBaseStyleUpdate(): StyleUpdate {
  return { sheetIdx: 0, row: 0, col: 0, payload: undefined };
}
