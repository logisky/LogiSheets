...
export class ColorPickerComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    public slider: SliderPosition = new SliderPosition();
    ...
    public cpCmykEnabled: boolean = false;
    ...
    public cpCloseClickOutside: boolean = false;
    ...
    public cpAddColorButton: boolean = false;
    ...
    private updateColorPicker(emit: boolean = true, update: boolean = true, cmykInput: boolean = false): void {
        ...
        if (update) {
            ...
            if (this.cpCmykEnabled && this.cmyk) {
            ...
            this.hexAlpha = this.rgbaText?.a ?? 0;
        }
        ...
        if (this.cpOutputFormat && this.cpAlphaChannel)
