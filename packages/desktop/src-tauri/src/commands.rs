...
use logisheets_rs::rpc::{controller, ws, Manager, Message};
                ...
                let v = if let Message::NewWorkbook = &msg {
                    ...
                    match msg {
                        ...
                        Message::GetCellListValidation(params) => {
                            ok_to_json(&ws::get_cell_list_validation(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.row,
                        ...
                        Message::GetCellsExceptWindow(params) => {
                            res_to_json(ws::get_cell_infos_except_window(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.start_row,
                        ...
                        Message::GetReproducibleCells(params) => {
                            res_to_json(ws::get_reproducible_cells(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.coordinates,
                        ...
                        Message::GetReproducibleCell(params) => {
                            res_to_json(ws::get_reproducible_cell(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.row,
                        ...
                        Message::GetRowHeight(params) => res_to_json(ws::get_row_height(
                            &mgr,
                            id,
                            params.sheet_id,
                            params.row_idx,
                        )),
                        Message::GetColWidth(params) => res_to_json(ws::get_col_width(
                            &mgr,
                            id,
                            params.sheet_id,
                            params.col_idx,
                        ...
                        Message::HandleTransaction(params) => {
                            let effect =
                                controller::handle_transaction(&mut mgr, id, params.transaction);
                        ...
                        Message::BatchGetCellInfoById(params) => res_to_json(
                            controller::batch_get_cell_info_by_id(&mut mgr, id, params.ids),
                        ),
                        Message::BatchGetCellCoordinateWithSheetById(params) => {
                            res_to_json(controller::batch_get_cell_coordinate_with_sheet_by_id(
                        ...
                        Message::LoadWorkbook(params) => ok_to_json(&controller::read_file(
                            &mut mgr,
                            id,
                            params.name,
                            &params.content,
                        ...
                        Message::GetComments(params) => {
                            ok_to_json(&ws::get_comments(&mgr, id, params.sheet_idx))
                        }
                        Message::GetCellImages(params) => {
                            ok_to_json(&ws::get_cell_images(&mgr, id, params.sheet_idx))
                        }
                        Message::GetCharts(params) => {
                            ok_to_json(&ws::get_charts(&mgr, id, params.sheet_idx))
                        }
                        ...
                        Message::GetCellIdByBlockRef(params) => {
                            res_to_json(controller::get_cell_id_by_block_ref(
                                &mgr,
                                id,
                                params.ref_name,
                                params.key,
                        ...
                        Message::ExportBlockData(params) => {
                            res_to_json(controller::export_block_data(
                                &mgr,
                                id,
                                params.ref_name,
                                params.key_filter,
                        ...
                        Message::GetTempStatusChanges => {
                            res_to_json(controller::get_temp_status_changes(&mgr, id))
                        }
                        Message::GetBlockDisplayWindow(params) => {
                            res_to_json(controller::get_display_window_for_block(
                                &mut mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::GetBlockRowId(params) => {
                            res_to_json(controller::get_block_row_id(
                                &mut mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::GetBlockColId(params) => {
                            res_to_json(controller::get_block_col_id(
                                &mut mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::GetBlockValues(params) => {
                            res_to_json(controller::get_block_values(
                                &mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::GetBlockSortOrder(params) => {
                            res_to_json(controller::get_block_sort_order(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.block_id,
                        ...
                        Message::GetShadowCellId(params) => {
                            res_to_json(controller::get_shadow_cell_id(
                                &mut mgr,
                                id,
                                params.sheet_idx,
                                params.row_idx,
                        ...
                        Message::GetShadowCellIds(params) => {
                            res_to_json(controller::get_shadow_cell_ids(
                                &mut mgr,
                                id,
                                params.sheet_idx,
                                params.row_idx,
                        ...
                        Message::GetShadowInfoById(params) => res_to_json(
                            controller::get_shadow_info_by_id(&mut mgr, id, params.shadow_id),
                        ),
                        Message::GetDiyCellIdWithBlockId(params) => {
                            ok_to_json(&ws::get_diy_cell_id_with_block_id(
                                &mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::LookupAppendixUpward(params) => {
                            res_to_json(ws::lookup_appendix_upward(
                                &mgr,
                                id,
                                params.sheet_id,
                                params.block_id,
                        ...
                        Message::GetNextVisibleCell(params) => {
                            res_to_json(ws::get_next_visible_cell(
                                &mgr,
                                id,
                                params.sheet_idx,
                                params.row_idx,
                        ...
                        Message::GetRowInfo(params) => res_to_json(controller::get_row_info(
                            &mgr,
                            id,
                            params.sheet_idx,
                            params.row_idx,
                        )),
                        Message::GetAvailableBlockId(params) => res_to_json(
                            controller::get_available_block_id(&mut mgr, id, params.sheet_idx),
                        ),
                        ...
                        Message::GetAllBlockFields => {
                            res_to_json(controller::get_all_block_fields(&mut mgr, id))
                        }
                        Message::Release => {
                        ...
                        Message::GetSheetCount => {
                            ok_to_json(&controller::get_sheet_count(&mgr, id))
                        }
                        Message::GetAllSheetInfo => {
                            ok_to_json(&controller::get_all_sheet_info(&mgr, id))
                        }
                        ...
                        Message::CommitTempStatus => {
                            ok_to_json(&controller::commit_temp_status(&mut mgr, id))
                        }
                        Message::CheckBindBlock(params) => {
                            ok_to_json(&controller::check_bind_block(
                                &mut mgr,
                                id,
                                params.sheet_idx,
                                params.block_id,
                        ...
                        Message::GetColInfo(params) => res_to_json(ws::get_col_info(
                            &mgr,
                            id,
                            params.sheet_idx,
                            params.col_idx,
                        )),
                        Message::GetFullyCoveredBlocks(params) => {
                            res_to_json(ws::get_all_fully_covered_blocks(
                                &mgr,
                                id,
                                params.sheet_id,
                                params.row,
                        ...
                        Message::GetAllBlocks(params) => res_to_json(ws::get_all_blocks(
                            &mgr,
                            id,
                            params.sheet_idx,
                            params.sheet_id,
                        )),
                        Message::GetLinkableBlocks(params) => res_to_json(ws::get_linkable_blocks(
                            &mgr,
                            id,
                            params.sheet_idx,
                            params.col_cnt,
                        )),
                        Message::GetLinks(params) => {
                            res_to_json(ws::get_links(&mgr, id, params.sheet_idx))
                        }
