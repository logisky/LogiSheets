...
#[derive(XmlSerialize, XmlDeserialize, Default, Debug, Hash, PartialEq, Eq, Clone, TS)]
#[ts(file_name = "font_name.ts")]
...
#[derive(Debug, XmlSerialize, XmlDeserialize, PartialEq, Eq, Clone, Hash, Default, TS)]
#[ts(file_name = "cell_alignment.ts")]
...
#[ts(file_name = "cell_protection.ts")]
...
#[derive(Debug, XmlSerialize, XmlDeserialize, Hash, PartialEq, Eq, Clone, TS)]
...
#[derive(Debug, XmlSerialize, XmlDeserialize, Hash, PartialEq, Eq, Clone, TS)]
#[ts(file_name = "vertical_align_font_property.ts")]
pub struct CtVerticalAlignFontProperty {
    #[xmlserde(name = b"val", ty = "attr")]
    pub val: StVerticalAlignRun,
}

#[derive(Debug, XmlSerialize, XmlDeserialize, MapObj, Clone, TS)]
#[ts(file_name = "font_size.ts")]
