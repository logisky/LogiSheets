...
pub trait NameFetcherTrait {
    ...
    fn fetch_col_idx(&self, sheet_id: &SheetId, col_id: &ColId) -> usize;
    fn fetch_range(&self, sheet_id: &SheetId, range_id: &RangeId) -> Option<Range>;
    fn fetch_cube(&self, cube_id: &CubeId) -> Cube;
