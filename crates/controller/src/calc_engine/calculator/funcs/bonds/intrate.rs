use crate::calc_engine::calculator::math::bond::intrate;
    ...
    C: Connector,
{
    ...
    let result = if let Some(arg) = args_iter.next() {
        ...
        match b.floor() as u8 {
            0 => intrate::<UsPsa30_360>(settle, maturity, investment, redemption),
            1 => intrate::<ActualActual>(settle, maturity, investment, redemption),
            2 => intrate::<Actual360>(settle, maturity, investment, redemption),
            3 => intrate::<Actual365>(settle, maturity, investment, redemption),
            4 => intrate::<Europe30_360>(settle, maturity, investment, redemption),
            _ => unreachable!(),
        }
    } else {
        intrate::<UsPsa30_360>(settle, maturity, investment, redemption)
    };
